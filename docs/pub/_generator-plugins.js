...
(function (global){
/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+clojure+docker+fsharp+go+handlebars+haskell+java+json+lua+makefile+markdown+markup-templating+perl+php+powershell+protobuf+r+jsx+tsx+ruby+rust+sql+swift+typescript+wasm+yaml */
